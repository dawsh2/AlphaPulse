//! Venue and Asset Type Definitions
//! 
//! Defines all supported venues and asset types for the bijective ID system
...
impl VenueId {
    ...
    pub fn blockchain(&self) -> Option<VenueId> {
        match self {
            ...
            VenueId::Balancer | VenueId::Aave | VenueId::Compound | VenueId::MakerDAO |
            VenueId::Yearn | VenueId::Synthetix | VenueId::dYdX => Some(VenueId::Ethereum),
            
            VenueId::QuickSwap | VenueId::SushiSwapPolygon | VenueId::CurvePolygon |
            VenueId::AavePolygon | VenueId::BalancerPolygon => Some(VenueId::Polygon),
    ...
    pub fn supports_pools(&self) -> bool {
        matches!(self, 
            VenueId::UniswapV2 | VenueId::UniswapV3 | VenueId::SushiSwap | VenueId::Curve |
            VenueId::Balancer | VenueId::QuickSwap | VenueId::SushiSwapPolygon | 
            VenueId::CurvePolygon | VenueId::BalancerPolygon | VenueId::PancakeSwap |
            VenueId::UniswapV3Arbitrum | VenueId::SushiSwapArbitrum | VenueId::CurveArbitrum
        )
    }
    ...
    pub fn chain_id(&self) -> Option<u64> {
        match self {
            VenueId::Ethereum | VenueId::UniswapV2 | VenueId::UniswapV3 | VenueId::SushiSwap |
            VenueId::Curve | VenueId::Balancer | VenueId::Aave | VenueId::Compound |
            VenueId::MakerDAO | VenueId::Yearn | VenueId::Synthetix | VenueId::dYdX => Some(1),
            
            VenueId::Polygon | VenueId::QuickSwap | VenueId::SushiSwapPolygon | 
            VenueId::CurvePolygon | VenueId::AavePolygon | VenueId::BalancerPolygon => Some(137),
            
            VenueId::BinanceSmartChain | VenueId::PancakeSwap | VenueId::VenusProtocol => Some(56),
            
            VenueId::Arbitrum | VenueId::UniswapV3Arbitrum | VenueId::SushiSwapArbitrum |
...
mod tests {
    ...
    fn test_venue_blockchain_mapping() {
        ...
        assert_eq!(VenueId::PancakeSwap.blockchain(), Some(VenueId::BinanceSmartChain));
