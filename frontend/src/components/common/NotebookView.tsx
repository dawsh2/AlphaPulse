 ...
 * Renders all notebook cells including AI chat and regular cells
...
interface NotebookViewProps {
  ...
  onSetNotebookCells: (cells: NotebookCell[] | ((prev: NotebookCell[]) => NotebookCell[])) => void;
  onUpdateCellContent: (cellId: string, content: string) => void;
          ...
          if (cell.type === 'ai-chat') {
            return (
              <div 
                ...
                onClick={() => onSetActiveCell(cell.id)}
              >
              ...
              <div className={styles.cellContent}>
                ...
                <div className={styles.codeEditor}>
                  <Editor
                    ...
                    language="python"
                    value={cell.content}
                    onChange={(value) => onUpdateCellContent(cell.id, value || '')}
                    theme={theme}
                ...
                <textarea
                  ...
                  value={cell.content}
                  onChange={(e) => onUpdateCellContent(cell.id, e.target.value)}
