...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let btc_instrument = InstrumentId::ethereum_token("0xa0b86a33e6551006d5e1f17b45f7e9c7c4b5f0e2")?;
...
mod tests {
    ...
    fn test_orderbook_precision_handling() -> Result<(), Box<dyn std::error::Error>> {
        let instrument = InstrumentId::ethereum_token("0x1234567890123456789012345678901234567890")?;
