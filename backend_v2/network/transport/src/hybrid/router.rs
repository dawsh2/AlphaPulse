...
impl TransportRouter {
    ...
    fn route_with_channel_config(
        ...
        match &channel_config.mode {
            ...
            TransportMode::MessageQueue => {
                #[cfg(feature = "message-queues")]
                {
                    let queue_name = channel_config.queue_name.clone()
    ...
    pub fn get_channel_config(&self, target_node: &str, target_actor: &str) -> Option<&ChannelConfig> {
        let channel_key = format!("{}:{}", target_node, target_actor);
        self.channel_cache.get(&channel_key)
...
mod tests {
    ...
    fn create_test_config() -> TransportConfig {
        ...
        // Critical channel
        channels.insert("critical_actor".to_string(), ChannelConfig {
        ...
        #[cfg(feature = "message-queues")]
        channels.insert("normal_actor".to_string(), ChannelConfig {
    ...
    fn test_critical_actor_routing() {
        ...
        let decision = router.route_decision("node1", "critical_actor", Priority::Critical).unwrap();
    ...
    fn test_normal_actor_routing() {
        ...
        let decision = router.route_decision("node1", "normal_actor", Priority::Normal).unwrap();
    ...
    fn test_auto_mode_critical_priority() {
        ...
        let decision = router.route_decision("node1", "unknown_actor", Priority::Critical).unwrap();
