...
//!
//! This module contains immutable blockchain-related constants such as
//! event signatures, token addresses, and DEX router addresses.
//! These values are determined by deployed smart contracts and cannot change.
...
pub mod events {
    ...
    pub fn get_monitored_signatures() -> Vec<&'static str> {
        vec![
            UNISWAP_V2_SWAP,
            UNISWAP_V3_SWAP,
            UNISWAP_V3_MINT,
...
pub mod tokens {
    ...
    pub const WETH: &str = "0x7ceB23fD6bC0adDBd44Bd6f21b62d628Fc157ae1";
