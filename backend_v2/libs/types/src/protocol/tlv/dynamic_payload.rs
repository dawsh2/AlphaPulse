...
///
/// These constants define maximum capacities based on real-world usage patterns
/// with generous headroom for future growth.
pub const MAX_INSTRUMENTS: usize = 16; // Real usage: 1-5, generous headroom
pub const MAX_POOL_TOKENS: usize = 8; // Real usage: 2-4, handles complex Balancer
pub const MAX_ORDER_LEVELS: usize = 50; // Real usage: 10-30, generous headroom for deep books
