...
struct Args {
    ...
    #[arg(long, default_value = "/tmp/alphapulse/market_data.sock")]
    market_data_relay: String,

    /// Signal relay path
    #[arg(long, default_value = "/tmp/alphapulse/signals.sock")]
    signal_relay: String,

    /// Execution relay path
    #[arg(long, default_value = "/tmp/alphapulse/execution.sock")]
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tracing_subscriber::registry()
        .with(
            tracing_subscriber::EnvFilter::try_from_default_env()
                .unwrap_or_else(|_| "alphapulse_dashboard_websocket=info,warn".into()),
        )
    ...
    info!("Starting AlphaPulse Dashboard WebSocket Server");
