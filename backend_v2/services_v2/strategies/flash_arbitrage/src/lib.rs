...
//! ```rust
//! use alphapulse_flash_arbitrage::{StrategyEngine, FlashArbitrageConfig, DetectorConfig};
//! use alphapulse_protocol_v2::{RelayDomain, SourceType, TLVMessageBuilder};
//! use tokio::sync::mpsc;
//!
//! #[tokio::main]
...
//! ```rust
//! use alphapulse_flash_arbitrage::{Executor, FlashLoanProvider};
//!
